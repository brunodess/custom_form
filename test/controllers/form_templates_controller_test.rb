...
class FormTemplatesControllerTest < ActionController::TestCase
  ...
  test "should create form_template" do
    assert_difference('FormTemplate.count') do
      post :create, form_template: { description: @form_template.description, is_letter: @form_template.is_letter, name: @form_template.name }
    end
  ...
  test "should update form_template" do
    patch :update, id: @form_template, form_template: { description: @form_template.description, is_letter: @form_template.is_letter, name: @form_template.name }
    assert_redirected_to form_template_path(assigns(:form_template))
  end
