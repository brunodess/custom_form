...
class FormFieldsControllerTest < ActionController::TestCase
  ...
  test "should create form_field" do
    assert_difference('FormField.count') do
      post :create, form_field: { default: @form_field.default, field_type: @form_field.field_type, form_template_id: @form_field.form_template_id, is_mandatory: @form_field.is_mandatory, name: @form_field.name }
    end
  ...
  test "should update form_field" do
    patch :update, id: @form_field, form_field: { default: @form_field.default, field_type: @form_field.field_type, form_template_id: @form_field.form_template_id, is_mandatory: @form_field.is_mandatory, name: @form_field.name }
    assert_redirected_to form_field_path(assigns(:form_field))
  end
